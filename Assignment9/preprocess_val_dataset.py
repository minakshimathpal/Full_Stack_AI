...
val_folder = '/home/ubuntu/raw_data/extracted/ILSVRC/Data/CLS-LOC/val'  # Path to the val images
annotation_folder = '/home/ubuntu/raw_data/extracted/ILSVRC/Annotations/CLS-LOC/val'  # Path to the annotation XML files
